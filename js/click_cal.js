...
var stime;
var loc;
document.write("<div id=minical oncontextmenu='return false' ondragstart='return false' onselectstart='return false' style=\"background:buttonface; margin:5; padding:5;margin-top:2;border-top:1 solid buttonshadow;border-left: 1 solid buttonshadow;border-right: 1 solid buttonshadow;border-bottom:1 solid buttonshadow;width:160;display:none;position: absolute; z-index: 99; width:20%\"></div>");

function cal_position(this_f){
	...
	// 레이어가 나타날 위치를 셋팅한다.
	var divLeft = $(this_f).position().left
	var divTop = $(this_f).position().top
	//var divLeft = $(this_f).clientX + 10;
	//var divTop = this_f.clientY + 5;
