	...
	<table class="">
		...
		<thead class="admin_list">
			<tr>
				...
				<th scope="col" class="thead_th">소속</th>
				<th scope="col" class="thead_th">직위</th>
				<th scope="col" class="thead_th">전화번호</th>
				<th scope="col" class="thead_th">최종접속일</th>
			</tr>
		</thead>
		<tbody>
				<?php
			...
			<tr>				
				...
				<td class="tbody_td"><?=$r['fd_group']?></td>
				<td class="tbody_td"><?=$r['fd_position']?></td>
				<td class="tbody_td"><?=$r['fd_hp']?></td>
				<td class="tbody_td"><?=$r['fd_connect']?></td>			
			</tr>
			<?php 
				}
			?>
