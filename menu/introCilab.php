...
<section class="container">
	...
	<div class="contents">
		<div class="tabletInner">
			<div class="btnTab">
				<a href="./introCilab.php" class="on">Introduction</a>
			...
			<div class="cilab">
				...
				<p class="text">
					CILAB is a water-based venture business that develops, manufactures and operates submersible underwater robots, underwater sensors and underwater equipment.<br>
