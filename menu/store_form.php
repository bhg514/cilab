<?php
	...
	try{
		...
		/*$query = "INSERT into tb_order (fk_order_number, fd_date, fd_product_no, fd_product_name, fd_product_option, fd_product_count, fd_order_id, fd_order_hp, fd_order_name, fd_order_mail, fd_del_name, fd_del_zip, fd_del_address1, fd_del_address2,fd_del_address3, fd_del_address4, fd_del_hp, fd_del_comment, fd_price, fd_del_fee, fd_imp_uid, fd_merchant_uid) VALUES(".$order_number.",'".$date."', ".$no.",'".$product_name."' ,'".$product_option."' ,".$product_count." ,'".$user_id."', '".$order_hp."', '".$order_name."', '".$order_mail."', '".$del_name."', '".$del_zip."', '".$del_addr1."', '".$del_addr2."', '".$del_addr3."', '".$del_addr4."', '".$del_hp."', '".$comment."', '".$price."', '".$del_fee."', '".$imp_uid."', '".$merchant_uid."')";*/

		$query_order = "INSERT into tb_order (fk_order_number, fd_date, fd_product_count, fd_order_id, fd_order_hp, fd_order_name, fd_order_mail, fd_del_name, fd_del_zip, fd_del_address1, fd_del_address2,fd_del_address3, fd_del_address4, fd_del_hp, fd_price, fd_del_fee, fd_imp_uid, fd_merchant_uid) VALUES(".$order_number.",'".$date."',1 ,'".$user_id."', '".$order_hp."', '".$order_name."', '".$order_mail."', '".$del_name."', '".$del_zip."', '".$del_addr1."', '".$del_addr2."', '".$del_addr3."', '".$del_addr4."', '".$del_hp."', '".$comment."', '".$price."', '".$del_fee."', '".$imp_uid."', '".$merchant_uid."')";
		query_send_non_return($query_order);

		$last_uid = insert_id();


		$query_detail = "INSERT into tb_order_detail (fk_order_number, fk_product_no, fd_product_name, fd_option, fd_count) VALUES(".$last_uid.", ".$no.", '".$product_name."' ,'".$product_option."' ,".$product_count." )";
		
		echo ($query_detail);
		query_send_non_return($query_detail);
